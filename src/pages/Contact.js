      ...
      >
        <div className="w-full h-full max-w-7xl mx-auto px-8">
          ...
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-2 text-forest text-richbalck">
              Get in Touch
            </h2>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-4 text-sm text-verydarkgray text-center lg:text-left">
              <div>
                <strong className="text-richblack">Name:</strong> Abrar Hossain
              </div>
              <div>
                <strong>Email:</strong>{" "}
                <a
